    ...
    render() {
        return (
          ...
          <div className="toplevel">
            ...
            <p className="question"><span className="normalText">
            Let's start off with some intuition. Consider the oracle above. She's sneaky so she doesn't tell us explicitly what the weights on the various faces of the topic dice and corresponding word dice are. However, we have full access to the results of the oracle's dice rolling (the documents). It makes sense that we should be able to infer (work backwards) the properties of the dice that generated the documents based on the results of her dice rolling. How do we work backwards?
            ...
            <p className="question"><span className="normalText">Icons on the homepage were made by <a href="https://www.flaticon.com/authors/eucalyp">Eucalyp</a> and <a href="https://www.flaticon.com/authors/photo3idea-studio"> photo3idea-studio</a> from <a href="https://www.flaticon.com">www.flaticon.com</a>. The diagram above was made by <a href="https://aws.amazon.com/blogs/machine-learning/introduction-to-the-amazon-sagemaker-neural-topic-model/">Amazon</a>.</span></p>
